<%-- 
    Document   : ModificarRecomendacionesPage
    Created on : 26/10/2019, 11:39:25 AM
...
<html>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Modificar Recomendación</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="AdminPage.jsp"><span class="mdi mdi-home"></span>&nbsp;Inicio</a></li>
                            <li class="breadcrumb-item"><a href="#">Gest. Recomendaciones</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Modificar Recomendación</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <form name="form1" method="POST" action="ModificarRecomendacionesServlet" enctype="multipart/form-data"  >
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-10">
                                        <% List<Recomendacion> lista_recomendacion1 = (List<Recomendacion>) request.getAttribute("lista_combox");%>
                                        <select  name="listado_recomendacion" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                            <option value="0"> -- Selecccione -- </option>
                                            <% if (lista_recomendacion1 != null) {%>
                                            <% int i = 0;%>
                                            <c:forEach items="<%=lista_recomendacion1%>" var="recomen" >
                                                <option value="<%=lista_recomendacion1.get(i).id_recomendacion%>"><%=lista_recomendacion1.get(i).nombre_recomendacion%></option>
                                                <% i = i + 1;%>
                                            </c:forEach>
                                            <%}%>
                                        </select>
                                ...
                                <% Recomendacion aux_recomendacion = (Recomendacion) request.getAttribute("datos_dieta");%>

                                <% int aux_codigo = 0; %>
                                <% String aux_nom = ""; %>
                                <% String aux_descrip = ""; %>

                                <% if (aux_recomendacion != null) {%>
                                <% aux_codigo = aux_recomendacion.id_recomendacion; %>
                                <% aux_nom = aux_recomendacion.nombre_recomendacion; %>
                                <% aux_descrip = aux_recomendacion.descrip_recomendacion; %>
                                <%}%>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group mb-2 mr-sm-2">
                                            ...
                                            <% if (aux_recomendacion != null) {%>
                                            <% String ruta_foto = "img/img_bd/" + aux_recomendacion.img_recomendacion;%>
                                            <img src="<%=ruta_foto%>" alt="Sin Foto..." class="img-fluid" width="550" style="height: 220px !important">

                                            <%}%>
                                            <% if (aux_recomendacion == null) {%>
                                            <img src="..." alt="Sin Foto..." width="550px" style="height: 220px !important"/>
                                            <%}%>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <% List<Recomendacion> lista_recomedaciones = (List<Recomendacion>) request.getAttribute("lista_datos_tabla");%>
                                            <% if (lista_recomedaciones != null) {%>
                                            <% String nombre_page = "recomendacion"; %>
                                            <% int i = 0;%>
                                            <c:forEach items="<%=lista_recomedaciones%>" var="recomen" >
                                                <tr>
                                                    <td style="text-align:center;"><c:out value="<%=lista_recomedaciones.get(i).id_recomendacion%>"/></td>
                                                    <td><c:out value="<%=lista_recomedaciones.get(i).nombre_recomendacion%>"/></td>
                                                    <td style="text-align:center;"><c:out value="<%=lista_recomedaciones.get(i).descrip_recomendacion%>"/></td>
                                                    <% String ruta_foto = "img/img_bd/" + lista_recomedaciones.get(i).img_recomendacion;%>
