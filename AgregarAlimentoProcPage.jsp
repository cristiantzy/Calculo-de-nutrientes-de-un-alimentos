<%-- 
    Document   : AgregarAlimentoProcPage
    Created on : 24/10/2019, 11:11:34 AM
...
<html>
    ...
    <title>Agregar Alimento Procesado | Soft Nutricional</title>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Alimento Procesado</a></li>
    ...
    <form name="form1" action="AgregarAlimentoProcServlet" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputvitamina1" class="col-sm-2 col-form-label">Nombre Alimento Proc.</label>
                                    <div class="col-sm-10">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="submit" name="btn_agregar" class="btn btn-primary" value="Agregar Alimento Proc">
                                            </div>
                                        </div>
                                    </div>
                                </div>
