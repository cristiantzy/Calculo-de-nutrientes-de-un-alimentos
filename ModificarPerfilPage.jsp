<%-- 
    Document   : ModificarPerfilPage
    Created on : 21/10/2019, 11:31:16 AM
...
<html>
    ...
    <title>Modificar Perfil | Soft Nutricional</title>
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Modificar Perfil</h4>
    ...
    <form name="Form1" action="ModificarPerfilServlet" >
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="txt_nombre" value="<%=nombre%>" required="" class="form-control"  id="inputadmin1"  style="border-color: #4a5560;">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="txt_apellido" value="<%=apellidos%>" required="" class="form-control"  id="inputadmin2"  style="border-color: #4a5560;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="txt_usuario" value="<%=usuario%>" class="form-control" id="inputadmin3"  style="border-color: #4a5560;">
